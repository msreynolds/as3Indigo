...
public class IndigoConstants {

    // Indigo API Methods
    public static const INDIGO_API_SOCKET:String = "Socket";
    public static const INDIGO_API_RESTFUL:String = "Restful";

    //Indigo Socket State Names
    public static const INDIGO_SOCKET_STATE_DISCONNECTED:String = "Disconnected";
    public static const INDIGO_SOCKET_STATE_CONNECTING:String = "Connecting";
    public static const INDIGO_SOCKET_STATE_CONNECTED:String = "Connected";
